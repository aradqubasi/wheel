...
class SWInmemoryIngredientRepository: SWIngredientRepository {
    ...
    func getAll() -> [SWIngredient] {
        ...
        return [
            ...
            SWIngredient(id: 42, "apple", of: .fruits, as: UIImage.cookedgrains, UIImage.cookedgrains, quantity: 0.5, unit: 10),
            SWIngredient(id: 43, "blueberry", of: .fruits, as: UIImage.cottagecheese, UIImage.cottagecheese, quantity: 1, unit: 9),
            SWIngredient(id: 44, "orange", of: .fruits, as: UIImage.hotpepper, UIImage.hotpepper, quantity: 0.5, unit: 10),
            SWIngredient(id: 45, "grapefruit", of: .fruits, as: UIImage.olives, UIImage.olives, quantity: 0.5, unit: 10),
            SWIngredient(id: 46, "grapes", of: .fruits, as: UIImage.onion, UIImage.onion, quantity: 1, unit: 9),
