...
class SWInmemoryIngredientRepository: SWIngredientRepository {
    ...
    func getAll() -> [SWIngredient] {
        ...
        return [
            ...
            SWIngredient(id: 10, "cashewnut", of: .fat, as: UIImage.Cashewnut, UIImage.cashewnut, quantity: 6, unit: 8),
            SWIngredient(id: 11, "avocado", of: .fat, as: UIImage.Avocado, UIImage.avocado, quantity: 1, unit: 8),
            SWIngredient(id: 12, "peanut", of: .fat, as: UIImage.Peanut, UIImage.peanut, quantity: 30, unit: 1),
            ...
            SWIngredient(id: 21, "corn", of: .veggy, as: UIImage.Corn, UIImage.corn, quantity: 30, unit: 1),
            ...
            SWIngredient(id: 25, "beans", of: .protein, as: UIImage.Beans, UIImage.beans, quantity: 30, unit: 1),
            SWIngredient(id: 26, "friedegg", of: .protein, as: UIImage.Friedegg, UIImage.friedegg, quantity: 1, unit: 10),
            SWIngredient(id: 27, "lentils", of: .protein, as: UIImage.Lentils, UIImage.lentils, quantity: 3, unit: 3),
            ...
            SWIngredient(id: 32, "yogurt", of: .dressing, as: UIImage.yogurt, UIImage.yogurt, quantity: 60, unit: 1),
            ...
            SWIngredient(id: 37, "cottage cheese", of: .unexpected, as: UIImage.cottagecheese, UIImage.cottagecheese, quantity: 120, unit: 1),
            ...
            SWIngredient(id: 43, "blueberry", of: .fruits, as: #imageLiteral(resourceName: "wheels/fruits/blueberries"), #imageLiteral(resourceName: "wheels/fruits/blueberries"), quantity: 30, unit: 1),
