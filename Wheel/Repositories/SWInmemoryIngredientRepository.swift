...
class SWInmemoryIngredientRepository: SWIngredientRepository {
    ...
    func getAll() -> [SWIngredient] {
        ...
        return [
            ...
            SWIngredient(id: 6, "coconut", of: .fat, as: UIImage.Coconut, UIImage.coconut, quantity: 100, unit: 1),
            SWIngredient(id: 7, "hazelnut", of: .fat, as: UIImage.Hazelnut, UIImage.hazelnut, quantity: 100, unit: 1),
            SWIngredient(id: 8, "seeds", of: .fat, as: UIImage.Seeds, UIImage.seeds, quantity: 100, unit: 1),
            SWIngredient(id: 9, "brazilnut", of: .fat, as: UIImage.Brazilnut, UIImage.brazilnut, quantity: 100, unit: 1),
            SWIngredient(id: 10, "cashewnut", of: .fat, as: UIImage.Cashewnut, UIImage.cashewnut, quantity: 100, unit: 1),
            SWIngredient(id: 11, "avocado", of: .fat, as: UIImage.Avocado, UIImage.avocado, quantity: 100, unit: 1),
            SWIngredient(id: 12, "peanut", of: .fat, as: UIImage.Peanut, UIImage.peanut, quantity: 100, unit: 1),
            ...
            SWIngredient(id: 30, "cooked grains", of: .dressing, as: UIImage.cookedgrains, UIImage.cookedgrains, quantity: 100, unit: 1),
            SWIngredient(id: 31, "cottage cheese", of: .dressing, as: UIImage.cottagecheese, UIImage.cottagecheese, quantity: 100, unit: 1),
            SWIngredient(id: 32, "hot pepper", of: .dressing, as: UIImage.hotpepper, UIImage.hotpepper, quantity: 100, unit: 1),
            SWIngredient(id: 33, "olives", of: .dressing, as: UIImage.olives, UIImage.olives, quantity: 100, unit: 1),
            SWIngredient(id: 34, "onion", of: .dressing, as: UIImage.onion, UIImage.onion, quantity: 100, unit: 1),
            SWIngredient(id: 35, "pickled veggies", of: .dressing, as: UIImage.pickledveggies, UIImage.pickledveggies, quantity: 100, unit: 1),
