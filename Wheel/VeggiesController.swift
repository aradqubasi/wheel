...
//            ]
//        ]
        let aubergine = PinView.create.name("aubergine").icon(default: UIImage.aubergine).icon(UIImage.Aubergine, for: .veggies)
        let tomato = PinView.create.name("tomato").icon(default: UIImage.tomato).icon(UIImage.Tomato, for: .veggies)
        let radish = PinView.create.name("radish").icon(default: UIImage.radish).icon(UIImage.Radish, for: .veggies)
        let pepper = PinView.create.name("pepper").icon(default: UIImage.pepper).icon(UIImage.Pepper, for: .veggies)
        let broccoli = PinView.create.name("broccoli").icon(default: UIImage.broccoli).icon(UIImage.Broccoli, for: .veggies)
        let carrot = PinView.create.name("carrot").icon(default: UIImage.carrot).icon(UIImage.Carrot, for: .veggies)
        let asparagus = PinView.create.name("asparagus").icon(default: UIImage.asparagus).icon(UIImage.Asparagus, for: .veggies)
        let cauliflower = PinView.create.name("cauliflower").icon(default: UIImage.cauliflower).icon(UIImage.Cauliflower, for: .veggies)
        let corn = PinView.create.name("corn").icon(default: UIImage.corn).icon(UIImage.Corn, for: .veggies)
